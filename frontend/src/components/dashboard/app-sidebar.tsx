        ...
        <div className={`flex flex-col h-full bg-slate-50/80 dark:bg-neutral-950 text-foreground w-80 border-r border-slate-200 dark:border-neutral-800 flex-shrink-0 transition-all duration-300 backdrop-blur-xl ${className}`}>
            ...
            <div className="p-4 border-b border-slate-200 dark:border-neutral-800 flex items-center justify-between h-[65px] bg-slate-100/50 dark:bg-neutral-900/50">
                ...
                <Button
                    ...
                    size="icon"
                    onClick={toggleTheme}
                    className="h-8 w-8 rounded-md hover:bg-slate-200 dark:hover:bg-neutral-800 transition-colors"
                >
                    {theme === "light" ? (
                        <Moon className="h-4 w-4 text-slate-600 dark:text-neutral-400" />
                    ) : (
                        <Sun className="h-4 w-4 text-slate-600 dark:text-neutral-400" />
                    )}
                </Button>
            </div>
            ...
            <div className="p-3 pb-0">
                <CreateTaskDialog
                    trigger={
                        <Button className="w-full bg-white dark:bg-neutral-900 hover:bg-white/50 dark:hover:bg-neutral-800 text-muted-foreground hover:text-foreground border border-border dark:border-neutral-700 justify-start gap-2 h-9 text-sm font-medium transition-all shadow-sm hover:shadow-md cursor-pointer">
            ...
            {/* Footer / User Rail */}
            <div className="p-4 border-t border-slate-200 dark:border-neutral-800 bg-slate-100/30 dark:bg-neutral-900/30">
                <div className="mb-3 text-[10px] text-muted-foreground/60 text-center select-none">
                    Tip: Right-click items to delete
                </div>
                <div className="bg-gradient-to-br from-white to-gray-50 dark:from-neutral-900 dark:to-neutral-950 rounded-xl p-4 border border-border dark:border-neutral-800 shadow-sm relative overflow-hidden group">
